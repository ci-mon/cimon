...
dotnet ef migrations add monitor_order --context CimonDbContext --project ../Cimon.DB.Migrations.Sqlite  -- --DbProvider Sqlite
git add ../Cimon.DB.Migrations.Sqlite/*
dotnet ef migrations add monitor_order --context CimonDbContext --project ../Cimon.DB.Migrations.SqlServer  -- --DbProvider SqlServer
